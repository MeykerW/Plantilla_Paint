...
##################################################################################################################################
    def drawLineTo(self, endPoint):
        ...
        #Aqui se puede modificar elcodigo para que haga mas cosas como cuadrados etc, pero cumpliendo determinada condicion
...
class MainWindow(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("USADO POR MI PARA TI")
        self.resize(500, 500)
    ...
    def penWidth(self):
        newWidth, ok = QtGui.QInputDialog.getInteger(self, "Area de trabajo",
            "Selecciona el tamaño:", self.scribbleArea.penWidth(), 1, 50, 1)
        if ok:
    ...
    def createActions(self):
        self.openAct = QtGui.QAction("&Abrir...", self, shortcut="Ctrl+O",
            triggered=self.open)
        ...
        self.printAct = QtGui.QAction("&Imprimir...", self,
            triggered=self.scribbleArea.print_)

        self.exitAct = QtGui.QAction("Salir", self, shortcut="Ctrl+Q",
            triggered=self.close)

        self.penColorAct = QtGui.QAction("&Color de lapiz...", self,
            triggered=self.penColor)

        self.penWidthAct = QtGui.QAction("Tamaño...", self,
            triggered=self.penWidth)

        self.clearScreenAct = QtGui.QAction("&Limpiar pantalla", self,
            shortcut="Ctrl+L", triggered=self.scribbleArea.clearImage)

        self.aboutAct = QtGui.QAction("&Acerca", self, triggered=self.about)

        self.aboutQtAct = QtGui.QAction("Acerca de &Qt", self,
            triggered=QtGui.qApp.aboutQt)

    def createMenus(self):
        self.saveAsMenu = QtGui.QMenu("&Guardar como", self)
        for action in self.saveAsActs:
            self.saveAsMenu.addAction(action)

        fileMenu = QtGui.QMenu("&Archivo", self)
        ...
        optionMenu = QtGui.QMenu("&Opciones", self)
        optionMenu.addAction(self.penColorAct)
        optionMenu.addAction(self.penWidthAct)
        optionMenu.addSeparator()
        optionMenu.addAction(self.clearScreenAct)

        helpMenu = QtGui.QMenu("&Ayuda", self)
